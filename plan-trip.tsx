  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="p-4 border-t">
              ...
              <div className="grid gap-4 mt-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold">Destination: Meerut to Delhi</div>
                    <div className="text-sm text-muted-foreground">Estimated travel time: 45 minutes</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
      ...
      <footer className="bg-primary text-primary-foreground py-4 px-6 flex items-center justify-between">
        <div className="text-sm">&copy; 2024 Mizo Explorer. All rights reserved Ujjwal Sharma.</div>
        <nav className="flex items-center gap-4">
          <Link href="#" className="hover:underline" prefetch={false}>
            Privacy
          </Link>
