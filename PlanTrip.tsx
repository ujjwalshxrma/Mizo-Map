...
* @see https://v0.dev/t/cfMmoDoymTg
    ...
    <div className="flex flex-col min-h-screen">
      <header className="bg-primary text-primary-foreground py-4 px-6 flex items-center justify-between">
        <Link href="#" className="flex items-center gap-2" prefetch={false}>
          ...
          <span className="text-xl font-semibold">Mizo Explore</span>
        </Link>
        ...
        <div className="grid grid-cols-[1fr_300px] gap-6 p-6">
          <div className="bg-muted rounded-lg overflow-hidden">
            ...
            <div className="p-4 border-t">
              <h2 className="text-lg font-semibold">Shortest Route</h2>
              <div className="grid gap-4 mt-4">
                <div className="flex items-center gap-4">
                  <WaypointsIcon className="w-8 h-8 text-primary" />
                  <div>
                    <div className="font-semibold">Destination: Aizawl</div>
                    <div className="text-sm text-muted-foreground">Estimated travel time: 3 hours</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Expect delays on Highway 1 due to construction.</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
      ...
      <footer className="bg-primary text-primary-foreground py-4 px-6 flex items-center justify-between">
        <div className="text-sm">&copy; 2024 Mizo Explore. All rights reserved.</div>
        <nav className="flex items-center gap-4">
          <Link href="#" className="hover:underline" prefetch={false}>
            Privacy
          </Link>
